    ...
    <section class="sidebar">	
				 ...
				 <a href="{{route('dashboard')}}">
				  <!-- logo for regular state and mobile devices -->
					 <div class="d-flex align-items-center justify-content-center">					 	
						  <img src="{{asset('backend/images/xarala.png')}}" alt="" width=100px>
						  <h3><b>LMS</b> Admin</h3>
					 </div>
				</a>
			</div>
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview {{($prefix =='/employees')?'active':''}}">
          <a href="#">
            <i data-feather="briefcase"></i> <span>Teacher Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('emp.view')}}"><i class="ti-more"></i>Teacher Registration</a></li>
            {{-- <li><a href="{{route('emp.salary.view')}}"><i class="ti-more"></i>Teacher Salary</a></li>
            <li><a href="{{route('emp.leave.view')}}"><i class="ti-more"></i>Teacher Leave</a></li> --}}
          </ul>
        </li>
