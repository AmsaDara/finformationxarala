...
<head>
  <meta charset="utf-8">
    ...
    <title>Système de gestion de l'apprentissage - Connexion </title>
                ...
                <div class="col-lg-4 col-md-5 col-12">
                    ...
                    <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-6">
                                    ...
                                    <label for="basic_checkbox_1">Souviens-toi de moi</label>
                                    </div>
                                </div>
                                <!-- /.col -->
                                <div class="col-6">
                        ...
                        <div class="text-center">
                            <p class="mt-15 mb-0 text-white">Vous n'avez pas de compte ? <a href="{{route('register')}}" class="text-warning ml-5">S'inscrire</a></p>
                        </div>
                    </div>
                </div>
            </div>
